...
\begin{frame}{Metodologia}
  \begin{itemize}
    \item[$\blacktriangleright$] Estratégias para lidar com desbalanceamento de dados
      \begin{itemize}
        \item SMOTE~\cite{Fernndez2018}
        \item RUS~\cite{Yang2024}
        \item SMOTE-Tomek~\cite{Pereira2020}
        \item CS-SVM~\cite{Iranmehr2019}
      \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}{Metodologia}
  \begin{itemize}
    \item[$\blacktriangleright$] Métricas de desempenho
      \begin{itemize}
        \item Acurácia balanceada~\cite{Naidu2023}
        \item F1-score
        \item G-mean~\cite{Namvar2018}
        \item Precisão
        \item Sensibilidade
      \end{itemize}
  \end{itemize}
