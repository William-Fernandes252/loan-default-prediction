...
% Pacotes ADICIONAIS
% ---------------------
\usepackage{graphicx} % Permite rotacionar tabelas
\usepackage{array} % Melhorar o espaçamento entre as linhas das tabelas
\usepackage{colortbl} % Fornece comandos para alterar a cor das células de uma tabela
\usepackage{lipsum} % Geração de dummy text
\usepackage{amsmath, amssymb, mathrsfs, mathabx} % Comandos matemáticos avançados
...
% Define a cor 'preta' para ser usada no preenchimento das células
...
% Data dinâmica no formato "Mês de Ano"
\newcommand{\mesano}{%
