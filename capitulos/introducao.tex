...
Tradicionalmente, a avaliação de risco de crédito baseava-se em modelos estatísticos, como Regressão Logística e análise discriminante. No entanto, com o aumento da disponibilidade de dados e o avanço das técnicas de ciência de dados, algoritmos de aprendizado de máquina têm se destacado por oferecer maior acurácia na previsão da inadimplência. Esses modelos permitem generalizar padrões complexos no comportamento de tomadores de crédito, contribuindo para decisões mais precisas e ágeis~\cite{Shi2022}.
